...
local function updateBarColor()
    ...
    -- Set initial color to purple
    imageLabel.ImageColor3 = Color3.fromRGB(128, 0, 128) -- Purple

    -- Smooth transition from purple to white
    tweenColor(imageLabel, Color3.fromRGB(128, 0, 128), Color3.fromRGB(255, 255, 255), 2)
end
