...
SaitamaSection:NewButton("Itadori Yuji", "BY TP EXPLOIT", function()
    loadstring(game:HttpGet('https://raw.githubusercontent.com/Astrail5258/Tsb/Scripts/MainLoad.lua'))()
end)
